	...
	while($x <= $sheet['numRows']){
		...
		while($y <= $sheet['numCols']){
	      $cell = isset($sheet['cells'][$x][$y]) ? $sheet['cells'][$x][$y] : '';
 		  if(isset($sheet['cells'][$x][$y]) && $sheet['cells'][$x][2] == "Podologia"){
	...
	while($x <= $sheet['numRows']){
		...
		while($y <= $sheet['numCols']){
		  ...
		  if(isset($sheet['cells'][$x][$y]) && in_array($cell, $luoghi)){
			   ...
			   if (!in_array($str, $corsi) && $cellPrec != "Podologia") {
	...
	<div class="intro">
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!-- Main -->
					<section class="sect">
					  <header class="section_header">Corso di Podologia </header>
<h3>Definizione</h3>
<p>Professionista che individua i bisogni preventivi podologici e somministra i relativi interventi, attraverso la valutazione dei dati
 clinici e dell’anamnesi.</p>
<h3>Funzioni</h3>
<ul>
	<li>Si occupa dell’esame obiettivo del piede, accompagnato da una corretta anamnesi famigliare, fisiologica, patologica del paziente</li>
	<li>Identifica i bisogni di assistenza podologica, in rapporto alle differenti fasce d’età, alle diverse malattie o disabilità, 
	all’attività sportiva o lavorativa</li>
	<li>Esegue esami specialistici per individuare e trattare i piedi a rischio onde evitare eventuali malattie</li>
</ul>
  
<h3>Sbocchi lavorativi</h3>
<ul>
	<li>Ospedali pubblici e privati</li>
	<li>Aziende del settore tecnico ortopedico e riabilitazione </li>
	<li>Consultori </li>
	<li>Ambulatori privati</li>
	<li>Società sportive</li>
	<li>Centri sociali per anziani</li>
	<li>Case di cura</li>
	<li>Territorio</li>
	<li>Domicilio</li>
	<li>Informatore scientifico per aziende</li>
</ul>
...
<button class="rounded" id="butt1" onclick="location.href='http://corsi.unibo.it/Laurea/Podologia/Pagine/default.aspx'">Collegamento sito</button>
